...
document.addEventListener('DOMContentLoaded', function() {
      ...
      // alert("fetching")
      fetch('https://kudus1.pythonanywhere.com/jiji/resources/', {
          method: 'GET',
...
function categoryFilter(categoryId){
  ...
  fetch(`https://kudus1.pythonanywhere.com/jiji/resources/?category_id=${categoryId}`, {
    method: 'GET',
...
// alert("fetching")
  fetch(`https://kudus1.pythonanywhere.com/jiji/products/?&min_price=${minRange}&max_price=${maxRange}`, {
    method: 'GET',
...
function regionFilter(regionId){
  ...
  fetch(`https://kudus1.pythonanywhere.com/jiji/products/?category_id=${regionId}`, {
    method: 'GET',
...
// alert("fetching")
  fetch('https://kudus1.pythonanywhere.com/jiji/addcart/',{
    method: 'POST',
    headers:{
