document.addEventListener('DOMContentLoaded', function() {
    ...
    // alert("fetching")
    fetch('https://kudus1.pythonanywhere.com/jiji/carts/', {
        method: 'GET',
...
function updateCartHome(data){
  ...
  function deleteItem(id){
    ...
    fetch(`https://kudus1.pythonanywhere.com/jiji/carts/${id}/`, {
        method: 'DELETE',
  ...
  function orderItem(id,quant){
    ...
    fetch(`https://kudus1.pythonanywhere.com/jiji/carts/${item}/`,{
        method: 'PATCH',
        headers:{
